<!DOCTYPE html>
    ...
    <body>
        <br>
        <div class="container">
            <h2 class="alert alert-success text-center">Data Mahasiswa</h2>
            <div class="row">
                <div class="col-5">
                    <div class="card">
                        <div class="card-body">
                            <form id="form-input">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="npm" name="npm" placeholder="Input Npm">
                                </div>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="matkul" class="form-control" id="matkul">
                                        <option value="Akhlak Etika">Akhlak Etika</option>
                                        <option value="Pemrograman">Pemograman</option>
